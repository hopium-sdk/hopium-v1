...
export const Detf = () => {
  ...
  return (
    <div className="w-full h-fit flex flex-col items-center justify-center pb-15">
      ...
      <div className="flex flex-col lg:flex-row items-center gap-2 pt-10">
...
export const Coins = () => {
  return (
    <div className="flex flex-row items-center justify-center lg:gap-2 rotate-5 float -translate-x-5 mt-12">
